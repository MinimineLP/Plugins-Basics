...
import com.github.miniminelp.basics.fly.Fly;
...
import com.github.miniminelp.basics.vanish.Vanish;
...
public class Basics extends JavaPlugin{
	...
	private void registerSubs(){
		...
		if(config.getBoolean("Basics.Modulmanager.vanish"))objects.add(new Vanish());
		if(config.getBoolean("Basics.Modulmanager.fly"))objects.add(new Fly());
